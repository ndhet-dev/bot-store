...
const product = {
   product: ["VCC", "CLOUD", "DOMAIN", "APP PREMIUM", "TUNNELING", "NPWP", "LEGALITAS PT"],
}
...
export default {
   ...
   options: {
      ...
      prefix: /^[°•π÷×¶∆£¢€¥®™+✓_=|/~!?@#%^&.©^]/i,
      pairingNumber: "6285691422621" // Example Input : 62xxx
   ...
   Exif: {
      packId: "https://sshaxor.my.id",
      packName: `Owner:`,
      packPublish: "Dendi Ramadhan",
      packEmail: "dendi@nasa.gov",
      packWebsite: "https://sshaxor.my.id",
